...
public class App {
    ...
    public static void main(String[] args) {
        ...
        burger.addMenuItems(new MenuItem("ShackBurger", 6.9, "토마토, 양상추, 쉑소스가 토핑된 치즈버거"));
        burger.addMenuItems(new MenuItem("SmokeShack", 8.9, "베이컨, 체리 페퍼에 쉑소스가 토핑된 치즈버거"));
        burger.addMenuItems(new MenuItem("Cheeseburger", 6.9, "포테이토 번과 비프패티, 치즈가 토핑된 치즈버거"));
        burger.addMenuItems(new MenuItem("Hamburger", 5.4, "비프패티를 기반으로 야채가 들어간 기본버거"));
        burger.addMenuItems(new MenuItem("MinSang'sBurger", 110.0, "민상님의 비밀레시피로 만들어진 특제버거"));
        burger.addMenuItems(new MenuItem("ShackShackBurger", 6.9, "토마토, 양상추, 쉑소스가 두배!! 토핑된 치즈버거"));
        ...
        burger.addMenuItems(new MenuItem("Small-Burger", 6.9, "토마토, 양상추, 쉑소스가 토핑된 스몰버거"));
